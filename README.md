...
[![Boss Machine](./public/img/boss-machine.png)](https://s3.amazonaws.com/codecademy-content/programs/build-apis/solution-videos/BossMachine480.mov "Boss Machine")
...
Generally, you will not have to touch anything inside the **browser**, **public**, or **node_modules** folders unless you want to customize the look of the Boss Machine. Before doing any of that, however, let's focus on getting the API server up and running:

### Server Boilerplate (The below has been implemented)
...
#### Routes added as part of the project
